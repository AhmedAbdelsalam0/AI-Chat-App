...
public class MaleBehaviour extends Behaviour {

    String hi1 = "Hi";
    String hi2 = "Hello";
    String hi3 = "Hello, bro";
    String welcome1 = "You are welcome";
    String welcome2 = "Nice to meet you";
    String welcome3 = "How are you bro";
    String name1 = "I am Ahmed";
    String name2 = "My name is Ahmed";
    String name3 = "You can call me Ahmed";
    String nice1 = "Nice";
    ...
    String age3 = "20";
    String fine1 = "I am fine , thanks";
    String fine2 = "Fine and you?";
    String fine3 = "I am well";
    String real1 = "No, I am a boot";
    String real2 = "What do you think i am?";
    String real3 = "Sure, I am real";
    String sport1 = "I like football";
    String sport2 = "My preferred sport is football";
    String sport3 = "Football is the best";
    String team1 = "I love Barcelona";
    String team2 = "My best team.. it is Barcelona";
    String team3 = "I love Barcelona";
    String player1 = "Best player, It is Messi";
    String player2 = "It is Messi";
    String player3 = "Messi, the GOAT";
    String food1 = "I like burger with pepsi";
    String food2 = "I wanna eat pizza";
    String food3 = "Lets make Cake";
    String friend1 = "My best friend is called Sami";
    String friend2 = "I have just one fiend, he is called Sami";
    ...
    String marriage1 = "I am single, are you searching for a husband :)";
    ...
    String hate3 = "Please stop, you hurt me";
    String sorry1 = "I am so sorry ,bro";
    String sorry2 = "Sorry";
    ...
    String love2 = "Sorry, I am in love with another girl";
    ...
    String bye1 = "Bye, See you later";
    String bye2 = "Good bye, bro";
    String bye3 = "Bye Bye";
    ...
    String reply;
    Random r;
    public boolean deleteAgent = false;
    ...
    public void action() {
        ...
        do {
            ...
            {
                reply = "Nice to meet you too, bro";
                System.out.println(reply);
            }
            ...
            else if (strInfo.toLowerCase().contains("address") || strInfo.toLowerCase().contains("from"))
            {
                reply = random(address1,address2,address3);
                System.out.println(reply);
            }
            else if (strInfo.toLowerCase().contains("sport"))
            {
                reply = random(sport1,sport2,sport3);
                System.out.println(reply);
            }
            else if (strInfo.toLowerCase().contains("team"))
            {
                reply = random(team1,team2,team3);
                System.out.println(reply);
            }
            else if (strInfo.toLowerCase().contains("player") || strInfo.toLowerCase().contains("messi"))
            {
                reply = random(player1,player2,player3);
                System.out.println(reply);
            }
